...
class CommentController extends AbstractController
{
    ...
    private function createSearchForm()
    {
        ...
        return $this->createFormBuilder($data)->setAction($this->generateUrl('admin_comment_list'))->setMethod(Request::METHOD_GET)->add('id', TextType::class, ['required' => false, 'label' => 'Id'])->add('submit', SubmitType::class, ['label' => 'Search'])->getForm();
    }
