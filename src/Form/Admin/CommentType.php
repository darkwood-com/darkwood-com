...
class CommentType extends \Symfony\Component\Form\AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('page', \Symfony\Bridge\Doctrine\Form\Type\EntityType::class, ['class' => Page::class, 'placeholder' => '- Choisissez une page -', 'query_builder' => function (EntityRepository $er) use ($locale) {
