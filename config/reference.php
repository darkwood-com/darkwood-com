 ...
 *     }>,
 * }
 * @psalm-type DarkwoodIaExceptionConfig = array{
 *     enabled?: bool|Param, // Enable AI exception analysis. Set to true only when appropriate (dev/staging or sanitized production). // Default: false
 *     only_status_codes?: list<int|Param>,
 *     agent?: scalar|Param|null, // Symfony AI agent service ID to use for analysis. // Default: "ai.agent.default"
 *     timeout_ms?: int|Param, // Max milliseconds to wait for AI response before fallback. // Default: 800
 *     cache_ttl?: int|Param, // Cache TTL in seconds (0 = disable cache). // Default: 600
 ...
 *     ai?: AiConfig,
 *     darkwood_ia_exception?: DarkwoodIaExceptionConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
